        ...
        <form method="POST" action="{{ route('email.change',array(),false) }}" class="w-1/2">
            ...
            <div class="form-control mt-8 mb-16">
                ...
                <label for"title" class="label">
                    <span class="label-text text-lg">現在のメールアドレス</span>
                </label>
                ...
                <label for"title" class="label mt-10">
                    <span class="label-text text-lg">新しいメールアドレス</span>
                </label>
                <input type="text" class="input input-bordered w-full" name="new_email" value="{{ old('new_email') }}">

                {{-- 状態選択 --}}
                <label for"title" class="label mt-10">
                    <span class="label-text text-lg">新しいメールアドレス(確認)</span>
                </label>
                ...
                <div class="flex justify-between mt-16 mx-12">
                    <button type="submit" class="btn  bg-blue-600 text-xl w-28">変更</button>
